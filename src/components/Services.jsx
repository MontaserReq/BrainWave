      ...
      <div className="relative">
        <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
          ...
          <div className="relative z-1 max-w-[17rem] ml-auto">
            <h4 className='h4 mb-4'>Smarttest AI</h4>
          ...
          <Generating
          className={'absolute left-4 right-4 bottom-4 border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2'}
          />
        </div>
        <div className="relative z-1 grid gap5 lg:grid-cols-2">
          ...
          <div className="p-4 bg-n-7 ruonded-3xl overflow-hidden lg:min-h-[46rem]">
            <div className="py-12 px-4 xl:px-8">
              <h4 className='h4 mb-4 '>Video genertation</h4>
              ...
              <ul className='flex items-center justify-between'>
                  {brainwaveServicesIcons.map((item,index)=>(
                    <li key={index} className={`flex items-center justify-center ${index===2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]':'felx w-10 h-10 bg-n-6 md:2-15 md:h-15 ' }`}>
